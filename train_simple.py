...
model.fit_generator(train_generator, steps_per_epoch=int(11848 // 64), epochs=20,
                    validation_data=test_generator, validation_steps=int(1317 // 64))

score = model.evaluate(X_test, Y_test)
print('\nTest accuracy: ', score[1])

print("complete score array:")
print(score)
